...
import {CompanyTable, Pagination, ErrorAlert} from 'common/components';

import {useListCompany} from '../context/hooks';

function CompanyCollections(): JSX.Element {
    const LIMIT = 10;
    ...
    const columns = useMemo(
        () => [
              ...
              {
                Header: 'Company Account Type',
                accessor: (row: any): string => row.companySettingId?.accountType,
              },
            ],
            [],
          );
